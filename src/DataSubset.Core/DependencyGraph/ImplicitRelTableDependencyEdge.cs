...
namespace DataSubset.Core.DependencyGraph
{
    ...
    /// the target rows.
    /// </remarks>
    public class ImplicitRelTableDependencyEdge : ITableDependencyEdge
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImplicitRelTableDependencyEdge"/> class.
        /// </summary>
        ...
        public ImplicitRelTableDependencyEdge(string referencedSchema, string referencedTable, IEnumerable<ColumnBinding> columnBindings, string? whereClause = null)
        {
