...
namespace DataSubset.Core.DependencyGraph
{
    ...
    /// </summary>
    /// <remarks>
    /// This implementation of <see cref="ITableDependencyEdge"/> captures the source schema/table and the
    /// set of column-level bindings that participate in the relationship, along with the backing database
    /// foreign key constraint name.
    /// </remarks>
    public class FkTableDependencyEdge : ITableDependencyEdge
    {
        /// <summary>
        ...
        /// </remarks>
        public IEnumerable<ColumnBinding> ColumnBindings { get; private set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="FkTableDependencyEdge"/> class.
        /// </summary>
        ...
        public FkTableDependencyEdge(string sourceSchema, string sourceTable, IEnumerable<ColumnBinding> columnBindings, string constraintName)
        {
