...
namespace DataSubsetCore.DependencyGraph
{
    ...
    ///   <item><description><see cref="ITableDependencyEdge"/> describes edge metadata such as column bindings between tables.</description></item>
    /// </list>
    ...
    /// <seealso cref="ITableDependencyEdge"/>
    /// <seealso cref="DirectedGraph{TNode, TEdgeData}"/>
    public class DatabaseGraph : DirectedGraph<TableNode, ITableDependencyEdge>
    {
        /// <summary>
