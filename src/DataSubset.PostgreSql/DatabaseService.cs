...
namespace DataSubset.PostgreSql
{
    ...
    public class DatabaseService : IDatabaseService
    {
        ...
        public async Task<List<ColumnInfo>> GetColumnMetadata(string schema, string tableName)
        {
            ...
            await using (var cmd = new NpgsqlCommand(columnQuery, _connection))
            {
            ...
            await using (var cmd = new NpgsqlCommand(pkQuery, _connection))
            {
                cmd.Parameters.AddWithValue(NpgsqlDbType.Text, schema);
                cmd.Parameters.AddWithValue(NpgsqlDbType.Text, tableName);
            ...
            await using (var cmd = new NpgsqlCommand(fkQuery, _connection))
            {
                cmd.Parameters.AddWithValue(NpgsqlDbType.Text, schema);
                cmd.Parameters.AddWithValue(NpgsqlDbType.Text, tableName);
