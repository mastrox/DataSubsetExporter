namespace DataSubset.DbDependencyGraph.Core.DependencyGraph
{
    ...
    public interface IDatabaseDependencyDiscoverer
    {
        ...
        /// Edges with <see cref="ITableDependencyEdgeData"/> metadata will be added to this graph.
        /// </param>
        /// <param name="schemas">
        ...
        /// - Edge metadata: implementations should populate <see cref="ITableDependencyEdgeData.ColumnBindings"/> to map
