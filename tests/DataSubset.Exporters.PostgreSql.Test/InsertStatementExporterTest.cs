...
namespace DataSubset.Exporters.PostgreSql.Test
{
    public class InsertStatementExporterTest
    {
        ...
        public async Task Multiple_RootTable_Separate_Hierarchy_Test()
        {
            ...
            (string firstTableName, int firtsIdToExport, string secondTableName, int secondIdToExport, string exportSchema, string importSchema, DatabaseGraph graph, TableExportConfig[] tableExportConfig) = await TestConfigurator.Multiple_RootTable_Separate_HierarchyConfig(connString, command);
        ...
        public async Task Multiple_RootTable_Overlapping_Hierarchy_Different_Data_Test()
        {
            (string connString, NpgsqlConnection connection) = await TestConfigurator.GetConnection();
            using var command = connection.CreateCommand();
            (string firstTableName, int firtsIdToExport, string secondTableName, int secondIdToExport, string exportSchema, string importSchema, DatabaseGraph graph, TableExportConfig[] tableExportConfig) = await TestConfigurator.Multiple_RootTable_Overlapping_Hierarchy_Different_DataConfig(connString);
        ...
        public async Task Multiple_RootTable_Overlapping_Hierarchy_Overlapping_Data_Test()
        {
            (string connString, NpgsqlConnection connection) = await TestConfigurator.GetConnection();
            using var command = connection.CreateCommand();
            (string firstTableName, int firtsIdToExport, string secondTableName, int secondIdToExport, string exportSchema, string importSchema, DatabaseGraph graph, TableExportConfig[] tableExportConfig) = await TestConfigurator.Multiple_RootTable_Overlapping_Hierarchy_Overlapping_DataConfig(connString, command);
        ...
        [Fact]
        public async Task StringArrayTypesTest()
        {
            int idToExport = 1;
            string createTableQuery = PostgresqlScripts.createStringArrayTable;
            string insertDataQuery = PostgresqlScripts.insertStringArrayTable;
            string tableName = "typetest";
            await PerformTypesTest(idToExport, createTableQuery, insertDataQuery, tableName);
        }
        ...
        [Fact]
        public async Task NumericRangeTypesTest()
        {
            int idToExport = 1;
            string createTableQuery = PostgresqlScripts.createNumericRangeTable;
            string insertDataQuery = PostgresqlScripts.insertNumericRangeTable;
            string tableName = "typetest";
            await PerformTypesTest(idToExport, createTableQuery, insertDataQuery, tableName);
        }
