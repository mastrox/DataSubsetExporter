...
namespace DataSubset.Exporters.PostgreSql.Test
{
    ...
    CONSTRAINT {1}_pk PRIMARY KEY (id)
        ...
        public static string createNumericRangeTable = @"CREATE TABLE {0}.{1} (
            id int NOT NULL,
            int4range_nn int4range NOT NULL,
            int4range_n int4range NULL,
            int8range_nn int8range NOT NULL,
            int8range_n int8range NULL,
            numrange_nn numrange NOT NULL,
            numrange_n numrange NULL,
            int4multirange_nn int4multirange NOT NULL,
            int4multirange_n int4multirange NULL,
            int8multirange_nn int8multirange NOT NULL,
            int8multirange_n int8multirange NULL,
            nummultirange_nn nummultirange NOT NULL,
            nummultirange_n nummultirange NULL,
            CONSTRAINT {1}_pk PRIMARY KEY (id)
        );";

        public static string insertNumericRangeTable = @"INSERT INTO {0}.{1} (id, int4range_nn, int4range_n, int8range_nn, int8range_n, numrange_nn, numrange_n, int4multirange_nn, int4multirange_n, int8multirange_nn, int8multirange_n, nummultirange_nn, nummultirange_n) VALUES (1, '[1,10]', '[100,200]', '[1000,2000]', '[10000,20000]', '[1.5,10.5]', '[100.25,200.75]', '{{[1,10],[20,30]}}', '{{[100,200],[300,400]}}', '{{[1000,2000],[3000,4000]}}', '{{[10000,20000],[30000,40000]}}', '{{[1.5,10.5],[20.25,30.75]}}', '{{[100.5,200.5],[300.25,400.75]}}');
        INSERT INTO {0}.{1} (id, int4range_nn, int4range_n, int8range_nn, int8range_n, numrange_nn, numrange_n, int4multirange_nn, int4multirange_n, int8multirange_nn, int8multirange_n, nummultirange_nn, nummultirange_n) VALUES (2, '[50,100]', NULL, '[5000,10000]', NULL, '[50.5,100.5]', NULL, '{{[50,60]}}', NULL, '{{[5000,6000]}}', NULL, '{{[50.5,60.5]}}', NULL);";
    }
}