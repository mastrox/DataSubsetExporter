...
namespace DataSubset.DbDependencyGraph.Core.Tests
{
    public class DepthFirsVisitorBaseTests
    {
        ...
        private sealed class RecordingVisitor : DepthFirsVisitorBase<string>
        {
            ...
            protected override string GetNodeContext(TableNode currentTable, ITableDependencyEdgeData? data, int depth)
            {
            ...
            protected override void ProcessCurrentNode(TableNode currentTable, ITableDependencyEdgeData? data, int depth, string? currentNodeContext)
            {
